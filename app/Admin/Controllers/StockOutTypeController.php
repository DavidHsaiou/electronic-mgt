...
class StockOutTypeController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new StockOutType());
    ...
    {
        $show = new Show(StockOutType::findOrFail($id));
    ...
    {
        $form = new Form(new StockOutType());
